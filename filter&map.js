...
//   let result = [];
//   result = ancestry.filter(item => 1924 - item.born <= 25 && item.died > 1924);
//   result = result.map(item => item.name);

//   return result;
// }

// let res = getYoungIn1924();
// console.log(res);

// function getAllMale() {
//   let result = [];
//   // result = ancestry.filter(item => item.sex === 'm')
//   // result = ancestry.map(item => {
//   //   if (item.sex === 'm') {
//   //     return item;
//   //   } else {
//   //     return null;
...
function getOlderThan50() {
  let result = [];
  result = ancestry.filter(item => item.died - item.born >= 50);
  result = result.map(item => item.died - item.born);

  return result;
}

let olderThan50List = getOlderThan50();
console.log(olderThan50List);
...
// function myReduce(array, reducer, result) {
//   let start = 0;
